import { n as services, t as getService } from "./services-data-oIchF6z1.js";
import { t as Route } from "./services._slug-B8chUXud.js";
import { n as Header, t as Footer } from "./Footer-CTni8_Gt.js";
import { t as FooterCTA } from "./PageHero-BAvrEB2y.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Check, CheckCircle, Cog, FileEdit, FileText, Hammer, HardHat, HelpCircle, IndianRupee, Landmark, Phone, Search, Sparkles, TrendingUp, User, Zap } from "lucide-react";
//#region src/components/site/ConsumerJourney.tsx
var journeySteps = [
	{
		id: 1,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(User, { className: "h-4 w-4 text-blue-500" }), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(HardHat, { className: "h-4 w-4 text-teal-500" }), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Zap, { className: "h-4 w-4 text-orange-500" }), /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Landmark, { className: "h-4 w-4 text-purple-500" }), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute left-6 md:left-1/2 top-0 bottom-0 w-[2px] bg-border/60 -translate-x-1/2" }), /* @__PURE__ */ jsx("div", {
					className: "space-y-8",
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									...
									children: isEven && /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-brand-navy-deep/95 via-brand-navy-deep/80 to-brand-navy-deep/50" }),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: service.specs.map((sp) => /* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							service.overview.map((p, i) => /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("p", {
								className: "text-primary font-semibold text-sm tracking-widest",
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: service.benefits.map((b, i) => /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("span", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-[3px] bg-gradient-to-r from-primary via-brand-gold to-primary scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left rounded-b-2xl" })
								]
							}, b.title))
						}),
						service.slug === "rooftop-solar" && /* @__PURE__ */ jsx("div", {
										...
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
											...
											children: [
												/* @__PURE__ */ jsxs("li", {
													...
													children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-primary shrink-0 mt-0.5" }), " Rs. 30,000 per kW up to 2 kW"]
												}),
												/* @__PURE__ */ jsxs("li", {
													className: "flex items-start gap-3",
													children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-primary shrink-0 mt-0.5" }), " Rs. 18,000 per kW for additional capacity up to 3 kW"]
												}),
												/* @__PURE__ */ jsxs("li", {
													className: "flex items-start gap-3",
													children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-primary shrink-0 mt-0.5" }), " Rs. 78,000 Total subsidy for systems larger than 3 kW capped at"]
												})
											]
										})] }),
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
											...
											children: /* @__PURE__ */ jsxs("li", {
												className: "flex items-start gap-3",
												children: [/* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-primary shrink-0 mt-0.5" }), " Rs. 18,000 per kW for common facilities, including EV charging, up to 500 kW capacity (@3 kW per house) with the upper limit being inclusive of individual rooftop plants installed by individual residents in the GHS/RWA"]
											})
										})] }),
										/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-brand-navy-deep/70 to-transparent" }),
									/* @__PURE__ */ jsxs("span", {
								...
								children: service.gallery.map((g, i) => /* @__PURE__ */ jsxs("button", {
									type: "button",
									onClick: () => setActive(i),
									...
									}), active !== i && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-brand-navy-deep/30 group-hover:bg-brand-navy-deep/10 transition" })]
								}, i))
							})]
						})
					]
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: service.process.map((p, i) => /* @__PURE__ */ jsxs("div", {
						...
						service.slug === "rooftop-solar" && /* @__PURE__ */ jsx(ConsumerJourney, {})
					]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(Cog, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("p", {
									className: "text-primary font-semibold text-sm tracking-widest",
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: service.techStack.map((t) => /* @__PURE__ */ jsxs("span", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-16 -right-16 h-56 w-56 rounded-full bg-primary/25 blur-3xl" }),
							/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-brand-gold/20 blur-3xl" }),
							/* @__PURE__ */ jsxs("div", {
								className: "relative",
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-2",
										children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("p", {
											className: "text-primary font-semibold text-sm tracking-widest",
											children: "CASE STUDY"
										})]
									}),
									...
									/* @__PURE__ */ jsxs(Link, {
										...
										children: ["View more projects ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
									})
								]
							})
						]
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(HelpCircle, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("p", {
								className: "text-primary font-semibold text-sm tracking-widest",
								children: "FAQ"
							})]
						}),
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: service.faqs.map((f, i) => /* @__PURE__ */ jsxs("details", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Request Free Quote ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								}), /* @__PURE__ */ jsx(Link, {
									to: "/contact",
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: ["All services ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
						})]
					}), /* @__PURE__ */ jsx("div", {
						className: "mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3",
						children: services.filter((s) => s.slug !== service.slug).slice(0, 3).map((s) => /* @__PURE__ */ jsxs(Link, {
							to: "/services/$slug",
							params: { slug: s.slug },
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-navy-deep/80 via-brand-navy-deep/20 to-transparent" }),
									/* @__PURE__ */ jsx("h3", {
								...
								children: [/* @__PURE__ */ jsx("span", { children: s.tag }), /* @__PURE__ */ jsxs("span", {
