...
import { Award, CheckCircle2, Clock, Headset, Leaf, Shield, Users } from "lucide-react";
//#region src/routes/why-us.tsx?tsr-split=component
var reasons = [
	{
		icon: Users,
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("p", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary" }), " WHY FLASH"]
							}),
							/* @__PURE__ */ jsxs("h2", {
						...
						children: reasons.map((r) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), " Included in every project"]
								})
							]
						}, r.title))
					})]
