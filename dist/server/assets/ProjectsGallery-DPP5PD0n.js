...
import { ArrowRight, Calendar, ChevronLeft, ChevronRight, MapPin, Tag, X, Zap, ZoomIn, ZoomOut } from "lucide-react";
//#endregion
//#region src/components/site/ProjectsGallery.tsx
var PROJECTS = [
	{
		id: "p1",
...
function ProjectsGallery() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("div", {
			...
			children: filtered.map((p, i) => /* @__PURE__ */ jsxs("button", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-brand-navy-deep via-brand-navy-deep/40 to-transparent" }),
					/* @__PURE__ */ jsxs("div", {
		...
		active && /* @__PURE__ */ jsxs("div", {
			...
			onClick: close,
			children: [
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-brand-navy-deep/85 backdrop-blur-md" }),
				/* @__PURE__ */ jsx("button", {
					onClick: (e) => {
						e.stopPropagation();
						prev();
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									children: zoomed ? /* @__PURE__ */ jsx(ZoomOut, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(ZoomIn, { className: "h-4 w-4" })
								}),
								/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-tr from-brand-navy-deep/60 via-transparent to-transparent md:bg-none" })
							]
						}), /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("dl", {
									...
									].map(({ icon: Icon, k, v }) => /* @__PURE__ */ jsxs("div", {
										className: "rounded-xl border border-white/10 bg-white/5 p-3",
										children: [
											/* @__PURE__ */ jsx(Icon, { className: "mx-auto h-4 w-4 text-primary" }),
											/* @__PURE__ */ jsx("dt", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: active.highlights.map((h) => /* @__PURE__ */ jsxs("li", {
											className: "flex items-start gap-2 text-sm text-white/85",
											children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" }), h]
										}, h))
									})]
								}),
								/* @__PURE__ */ jsxs("a", {
									...
									children: ["Discuss a similar project ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})
							]
						})]
					})]
