...
import { ArrowRight, CheckCircle2, Facebook, Globe, Instagram, LayoutDashboard, Linkedin, LogIn, LogOut, Mail, MapPin, Menu, Phone, Send, X, Youtube } from "lucide-react";
import { z } from "zod";
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-primary" }), "info@flashrenewable.com"]
						}), /* @__PURE__ */ jsxs("span", {
							className: "hidden lg:flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-primary" }), "PAN-India Solar EPC · MNRE Registered"]
						})]
					}), /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5" }), " +91 91500 11428"]
							}),
							/* @__PURE__ */ jsx("span", {
								className: "h-4 w-px bg-white/20",
								"aria-hidden": "true"
							}),
							adminToken ? /* @__PURE__ */ jsxs("div", {
								className: "relative",
								children: [/* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: (adminUser ?? "?").slice(0, 1).toUpperCase()
									}), /* @__PURE__ */ jsx("span", {
									...
									children: [/* @__PURE__ */ jsxs(Link, {
										...
										children: [/* @__PURE__ */ jsx(LayoutDashboard, { className: "h-3.5 w-3.5 text-primary" }), " Admin Dashboard"]
								...
								children: /* @__PURE__ */ jsxs(Link, {
									...
									children: [/* @__PURE__ */ jsx(LogIn, { className: "h-3.5 w-3.5" }), " Admin Login"]
								})
							})
						]
					})]
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("nav", {
									...
									children: ["Free Quote", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 group-hover:translate-x-0.5 transition-transform" })]
								})]
							}),
							/* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("nav", {
							...
							children: nav.map((n, i) => /* @__PURE__ */ jsxs(Link, {
								to: n.to,
								onClick: () => setOpen(false),
								...
								children: [/* @__PURE__ */ jsx("span", { children: n.label }), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 text-primary opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" })]
							}, n.label))
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-3",
							children: [
								...
								/* @__PURE__ */ jsxs("a", {
									...
									children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 text-primary" }), " +91 91500 11428"]
								}),
								/* @__PURE__ */ jsx("div", {
									className: "grid grid-cols-1 gap-3",
									children: adminToken ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Link, {
										to: "/admin",
										onClick: () => setOpen(false),
										...
										children: [/* @__PURE__ */ jsx(LayoutDashboard, { className: "h-4 w-4 text-primary" }), " Admin Dashboard"]
									}), /* @__PURE__ */ jsxs("button", {
										onClick: signOut,
										...
										children: [
											/* @__PURE__ */ jsx(LogOut, { className: "h-4 w-4 text-primary" }),
											" Sign out (",
											adminUser,
											")"
										]
										...
										children: [/* @__PURE__ */ jsx(LogIn, { className: "h-4 w-4 text-primary" }), " Admin Login"]
									})
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("p", {
								...
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-primary" }), " PAN-India · MNRE Registered"]
							})]
						})
					]
				})
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", {
								...
								].map(({ Icon, label, href }) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
									href,
									target: "_blank",
...
var emailSchema = z.string().trim().min(1, { message: "Email is required" }).email({ message: "Enter a valid email address" }).max(255, { message: "Email is too long" });
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", {
						...
						children: error ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("span", {
							className: "sr-only",
							children: "Error: "
						}), error] }) : ""
					}),
...
function FooterCol({ title, items, navLabel }) {
	...
	return /* @__PURE__ */ jsxs("nav", {
		...
		children: [/* @__PURE__ */ jsx("h4", {
			...
			children: items.map((it) => it.href ? /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
				to: it.href,
