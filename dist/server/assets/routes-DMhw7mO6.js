import { a as hero_2_default, i as hero_3_default, n as services, r as solar_house_3d_default } from "./services-data-oIchF6z1.js";
import { r as project_commercial_default, t as project_utility_default } from "./project-utility-CoJD2s69.js";
...
import { ArrowRight, Award, CheckCircle2, Clock, Globe, Headphones, Leaf, Lightbulb, Mail, MapPin, Phone, Quote, Smile, Star, Sun, Zap } from "lucide-react";
...
function Testimonials() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 h-96 w-[40rem] rounded-full bg-primary/10 blur-3xl" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("p", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "TESTIMONIALS"]
					}),
					/* @__PURE__ */ jsxs("h2", {
				...
				children: TESTIMONIALS.map((t) => /* @__PURE__ */ jsxs("figure", {
					...
					children: [
						/* @__PURE__ */ jsx("span", { className: "pointer-events-none absolute inset-x-7 top-0 h-0.5 bg-gradient-to-r from-primary via-brand-gold to-primary rounded-full scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500" }),
						/* @__PURE__ */ jsx(Quote, {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 fill-brand-gold text-brand-gold" }, i))
						}),
...
//#endregion
//#region src/assets/flash-1.png
var flash_1_default = "/assets/flash-1-DdsvOgD_.png";
//#endregion
//#region src/components/site/HomeComponent.tsx
var stats = [
	{
		icon: Sun,
		value: "500+",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					heroSlides.map((s, i) => /* @__PURE__ */ jsx("div", {
						...
						children: s.video ? /* @__PURE__ */ jsx("video", {
							src: s.video,
							autoPlay: true,
							loop: true,
							muted: true,
					...
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-brand-navy-deep/97 via-brand-navy-deep/80 to-brand-navy-deep/40" }),
					/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-navy-deep/90 via-transparent to-brand-navy-deep/50" })
				]
			}),
			/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("svg", {
									...
									children: /* @__PURE__ */ jsx("path", { d: "M2.5 12c2.5-1.5 5-2 7.5-1.5 1.5 3.5 2.5 5 4.5 4.5-1.5-2-2-4-1-6 2 1.5 4 2.5 6 2 1.5-.5 2.5-1 2-2-2-2.5-4-3-6-2.5-1.5 2-2.5 4-2 6-2 0-3.5-1.5-4.5-4C8.5 7 6.5 7.5 4 9c-1 1-1.5 2-1.5 3z" })
								})
							}),
							/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary animate-pulse" }), slide.tag]
						}, `tag-${active}`),
						/* @__PURE__ */ jsx("h1", {
							className: "mt-6 font-display text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] tracking-tight",
							children: slide.headline.map((line, li) => /* @__PURE__ */ jsx("span", {
								className: "block hero-text-in",
								style: {
									animationDelay: `${li * .1 + .05}s`,
									opacity: 0
								},
								children: line === slide.accent ? /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4" }), " +91 91500 11428"]
							})]
						}, `cta-${active}`),
						/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: heroSlides.map((_, i) => /* @__PURE__ */ jsx("button", {
										onClick: () => goTo(i),
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("p", {
									...
									children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary animate-pulse" }), " Solar Calculator"]
								}),
								/* @__PURE__ */ jsx("h3", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("button", {
									...
									children: ["Get Final Quote ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})]
							})]
						}) : /* @__PURE__ */ jsxs("form", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("button", {
									type: "submit",
									className: "w-full rounded-xl bg-gradient-to-r from-primary to-brand-gold py-3 text-sm font-bold text-brand-navy-deep shadow-[0_10px_30px_-8px_rgba(247,147,30,0.6)] hover:shadow-[0_14px_40px_-8px_rgba(247,147,30,0.8)] hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2",
									children: [/* @__PURE__ */ jsx(Lightbulb, { className: "h-4 w-4" }), " Calculate Now"]
								}),
								/* @__PURE__ */ jsx("p", {
						...
						children: [/* @__PURE__ */ jsxs("a", {
							...
							children: [/* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5 text-primary flex-shrink-0" }), " +91 91500 11428"]
						}), /* @__PURE__ */ jsxs("a", {
							...
							children: [/* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-primary flex-shrink-0" }), " info@flashrenewable.com"]
						})]
					})]
				})]
			}),
		...
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("p", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary" }), " ABOUT US"]
						}),
						/* @__PURE__ */ jsxs("h2", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: values.map((v) => /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(v.icon, { className: "h-6 w-6" })
								}), /* @__PURE__ */ jsx("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("img", {
								...
								children: [/* @__PURE__ */ jsx(Leaf, { className: "h-6 w-6 text-primary" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute top-[40%] -right-32 h-[28rem] w-[28rem] rounded-full bg-brand-gold/15 blur-3xl" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-40 -left-24 h-80 w-80 rounded-full bg-primary/20 blur-3xl" }),
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [
									/* @__PURE__ */ jsxs("p", {
										className: "text-primary font-semibold text-sm flex items-center gap-2 tracking-widest",
										children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "OUR SERVICES"]
									}),
									/* @__PURE__ */ jsxs("h2", {
									...
									children: ["Request a Consultation ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
								})]
							}), /* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("p", {
										...
										children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "WHAT MAKES US DIFFERENT"]
									}),
									/* @__PURE__ */ jsxs("h2", {
										className: "mt-3 font-display text-3xl md:text-5xl font-bold leading-tight",
										children: [
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsxs("p", {
							className: "text-primary font-semibold text-sm flex items-center gap-2",
							children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary" }), " OUR PROCESS"]
						}),
						/* @__PURE__ */ jsx("h2", {
							className: "mt-3 font-display text-3xl md:text-4xl font-bold text-brand-navy",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsxs("p", {
									className: "text-primary font-semibold text-sm flex items-center gap-2 tracking-widest",
									children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "OUR PROJECTS"]
								}),
								/* @__PURE__ */ jsxs("h2", {
									className: "mt-3 font-display text-3xl md:text-5xl font-bold leading-tight",
									children: [
								...
								children: whyus.slice(0, 4).map((w) => /* @__PURE__ */ jsxs("div", {
									className: "flex items-start gap-2 text-xs text-white/85",
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-primary shrink-0 mt-0.5" }), /* @__PURE__ */ jsx("span", { children: w })]
								}, w))
							})]
						}), /* @__PURE__ */ jsx(ProjectsGallery, {})]
					})
				]
			}),
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: [
							/* @__PURE__ */ jsxs("p", {
								className: "text-primary font-semibold text-sm flex items-center gap-2 tracking-widest",
								children: [/* @__PURE__ */ jsx("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "CONTACT US"]
							}),
							/* @__PURE__ */ jsxs("h2", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-r from-primary/15 via-transparent to-brand-gold/15" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-primary/25 blur-3xl" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -bottom-32 right-1/4 h-72 w-72 rounded-full bg-brand-gold/20 blur-3xl" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h3", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["Get a Free Quote ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							}), /* @__PURE__ */ jsxs("a", {
								href: "tel:+919150011428",
