...
import { AlertCircle, ArrowUpRight, CheckCircle, ClipboardList, Clock, FileText, Layers, Loader2, Mail, MessageSquare, MessageSquareQuote, Newspaper, Send, Sliders, TrendingUp, Users } from "lucide-react";
...
function StaffDashboard({ staffId }) {
	...
	if (loading) return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx(Loader2, { className: "h-10 w-10 animate-spin text-primary" })
	});
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(ClipboardList, { className: "h-6 w-6" })
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Clock, { className: "h-6 w-6 animate-pulse" })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-2xl font-bold text-brand-navy",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(CheckCircle, { className: "h-6 w-6" })
						}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "text-2xl font-bold text-brand-navy",
			...
			projects.length === 0 ? /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(AlertCircle, { className: "h-10 w-10 mx-auto text-slate-400 mb-3" }),
					/* @__PURE__ */ jsx("h3", {
				...
				}), selectedProj && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(FileText, { className: "h-4 w-4 text-primary" }), "Installation Instructions (From Admin)"]
								}), /* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("h3", {
										...
										children: [/* @__PURE__ */ jsx(Sliders, { className: "h-4 w-4 text-primary" }), " Update Progress"]
									}),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
											...
											children: [/* @__PURE__ */ jsx("span", { children: "Progress Percentage" }), /* @__PURE__ */ jsxs("span", {
									...
									/* @__PURE__ */ jsxs("button", {
										...
										children: [updating && /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), "Save Progress Updates"]
									})
								]
							})
						]
						...
						children: [
							/* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4 text-primary" }), " Collaboration logs & Messages"]
							}),
							/* @__PURE__ */ jsx("div", {
								className: "h-64 overflow-y-auto border rounded-xl bg-slate-50/50 p-4 space-y-3 flex flex-col",
								children: projectMessages.length === 0 ? /* @__PURE__ */ jsx("div", {
									...
									return /* @__PURE__ */ jsxs("div", {
										...
										}), /* @__PURE__ */ jsx("div", { children: m.message })]
									}, m.id);
								})
							}),
							/* @__PURE__ */ jsxs("form", {
...
function Dashboard() {
	...
	if (role === "staff") return /* @__PURE__ */ jsx(StaffDashboard, { staffId });
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Panel, {
					...
					children: recent.length === 0 ? /* @__PURE__ */ jsx(Empty, {}) : recent.map((r) => /* @__PURE__ */ jsxs("div", {
						...
						}), /* @__PURE__ */ jsx(StatusPill, { status: r.status })]
					}, String(r.id)))
				}), /* @__PURE__ */ jsx(Panel, {
					title: "Recent Quote Requests",
					to: "/admin/enquiries/quotes",
					children: recentQuotes.length === 0 ? /* @__PURE__ */ jsx(Empty, {}) : recentQuotes.map((r) => /* @__PURE__ */ jsxs("div", {
						className: "flex items-start justify-between gap-3 py-3 border-b last:border-0",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "min-w-0",
							children: [/* @__PURE__ */ jsxs("div", {
...
function StatCard({ icon: Icon, label, value, badge, tone }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: `absolute -top-6 -right-6 h-24 w-24 rounded-full bg-gradient-to-br ${tones[tone ?? "primary"]} blur-2xl opacity-70` }),
			/* @__PURE__ */ jsxs("div", {
...
function MiniStat({ label, value, to, icon: Icon }) {
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [
			...
			/* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 text-slate-400 group-hover:text-primary" })
		]
	});
}
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("h3", {
...
function Empty() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Clock, { className: "h-5 w-5" }), "No records yet."]
	});
}
		...
		children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs(AreaChart, {
						...
						children: [
							/* @__PURE__ */ jsx("defs", { children: [
								...
								["quotes", "#eab308"],
								["subscribers", "#0ea5e9"]
							].map(([k, c]) => /* @__PURE__ */ jsxs("linearGradient", {
								id: `g-${k}`,
								x1: "0",
								y1: "0",
								x2: "0",
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					className: "h-64 p-4",
					children: statusMix.length === 0 ? /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(PieChart, { children: [
							...
							/* @__PURE__ */ jsx(Pie, {
								...
								outerRadius: 80,
								paddingAngle: 3,
								children: statusMix.map((_, i) => /* @__PURE__ */ jsx(Cell, { fill: CHART_COLORS[i % CHART_COLORS.length] }, i))
							}),
							/* @__PURE__ */ jsx(Legend, { wrapperStyle: { fontSize: 12 } })
						] })
					})
