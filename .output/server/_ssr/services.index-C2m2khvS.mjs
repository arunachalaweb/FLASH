...
import { Pt as ArrowRight, St as ChevronUp, Tt as ChevronDown } from "../_libs/lucide-react.mjs";
import { n as Header, t as Footer } from "./Footer-C7UDJlwR.mjs";
import { n as PageHero, t as FooterCTA } from "./PageHero-BAvrEB2y.mjs";
import { i as services } from "./services-data-oIchF6z1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/services.index-C2m2khvS.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				...
				open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronUp, { className: "h-5 w-5 text-white/40 group-hover:text-primary transition-colors" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "h-5 w-5 text-white/40 group-hover:text-primary transition-colors" })
			]
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -bottom-40 -right-32 h-[28rem] w-[28rem] rounded-full bg-brand-gold/20 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -top-40 -right-32 h-96 w-96 rounded-full bg-primary/15 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -bottom-40 -left-32 h-[28rem] w-[28rem] rounded-full bg-brand-gold/10 blur-3xl" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "relative mx-auto max-w-7xl px-4 md:px-6",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-primary font-semibold text-sm flex items-center gap-2 tracking-widest",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-2 w-2 rounded-full bg-primary shadow-[0_0_12px_hsl(var(--primary))]" }), "OUR TECHNOLOGY PORTFOLIO"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: solarTechs.map((tech) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TechCard, { tech }, tech.name))
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-16",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
									...
									children: innovations.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
									...
									children: sectorApplications.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
