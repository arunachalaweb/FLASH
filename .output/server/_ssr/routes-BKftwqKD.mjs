...
import { G as Leaf, L as MapPin, Pt as ArrowRight, R as Mail, W as Lightbulb, _ as Sun, b as Smile, gt as Clock, it as Globe, j as Phone, jt as Award, k as Quote, r as Zap, tt as Headphones, v as Star, yt as CircleCheck } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BKftwqKD.js
...
function useCMS(pageSlug) {
	...
	(0, import_react.useEffect)(() => {
		...
		async function loadCMS() {
			try {
				const [slidesRes, contentRes] = await Promise.all([fetch(`${BACKEND_URL}/api/hero_slides`), fetch(`${BACKEND_URL}/api/page_content`)]);
				if (!active) return;
				if (slidesRes.ok && contentRes.ok) {
					const slidesData = await slidesRes.json();
					const contentData = await contentRes.json();
					const filteredSlides = slidesData.filter((s) => s.page_slug === pageSlug).sort((a, b) => a.sort_order - b.sort_order);
					const mappedContent = {};
					contentData.filter((c) => c.page_slug === pageSlug).forEach((c) => {
...
function HeroSection({ dbSlides }) {
	...
	const activeSlides = dbSlides && dbSlides.length > 0 ? dbSlides.map((s) => {
		return {
			img: s.image_url.startsWith("/") ? `${s.image_url}` : s.image_url,
			tag: s.title || "Powering a Bright & Green Future",
			headline: s.subtitle ? [s.subtitle] : [
				"Clean Energy,",
				"Engineered for",
				"India's Future."
			],
	...
	const startTimer = () => {
		...
		timerRef.current = setInterval(() => setActive((a) => (a + 1) % activeSlides.length), 6e3);
	};
	(0, import_react.useEffect)(() => {
		startTimer();
		return () => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					activeSlides.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function HomeComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeroSection, { dbSlides: slides }),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							...
							children: [
								...
								content.about_title?.subtitle && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
									" ",
									content.about_title.subtitle
								] }),
								!content.about_title && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}), " Solutions Pvt. Ltd."] })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-5 text-muted-foreground leading-relaxed",
							children: content.about_title?.body || "We are a leading renewable energy company delivering high-quality, cost-effective and sustainable solar solutions. From rooftop installations to large-scale solar power plants, we provide end-to-end EPC services with the highest standards of safety and performance."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
