...
//#region node_modules/.nitro/vite/services/ssr/assets/team-BeFNjbJ7.js
...
var SplitComponent = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminCrud, {
	...
	fields: [
		...
		},
		{
			...
			type: "text",
			required: true,
			placeholder: "e.g. Lead Installation Engineer"
		},
		{
			key: "email",
			label: "Email Address",
		...
		{
			key: "domain_core",
			label: "Core Specialization Domain",
			type: "text",
			placeholder: "e.g. Solar PV Commissioning, High Voltage Systems"
		},
		{
			key: "education",
		...
		},
		{
			...
			type: "text",
			placeholder: "e.g. 5+ Years in Grid-tied Solar System Design"
		},
		{
			key: "dob",
			label: "Date of Birth",
		...
		},
		{
			...
			type: "text",
			placeholder: "For login, e.g. rajesh_solar"
		},
		{
			key: "password",
