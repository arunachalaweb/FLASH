...
import imgEpc from "@/assets/service-epc.jpg";
import imgRooftop from "@/assets/service-rooftop.jpg";
import imgGround from "@/assets/service-ground.jpg";
import imgIndustrial from "@/assets/service-industrial.jpg";
import imgPump from "@/assets/service-pump.jpg";
import imgStreet from "@/assets/service-street.jpg";
import imgBattery from "@/assets/service-battery.jpg";
import imgOm from "@/assets/service-om.jpg";
...
import projUtility from "@/assets/project-utility.jpg";
...
export type Service = {
  ...
  techStack: string[];
  caseStudy: { title: string; location: string; capacity: string; result: string };
...
export const services: Service[] = [
  {
    ...
    image: imgEpc,
    intro:
      "A single accountable partner for the full EPC lifecycle — from feasibility to commissioning and grid handover.",
    overview: [
    ...
    process: [
      { title: "Site Assessment", desc: "Free site visit, load audit and shadow analysis." },
      { title: "Engineering Design", desc: "Detailed PVsyst simulation and SLD drawings." },
      { title: "Procurement", desc: "Tier-1 components sourced through direct OEM tie-ups." },
      { title: "Installation", desc: "Certified crews with strict QA/QC at every milestone." },
      { title: "Commissioning", desc: "Grid sync, DISCOM handover and PR testing." },
    ],
    specs: [
      { label: "Capacity", value: "3 kW – 10 MW+" },
      { label: "Warranty", value: "25 yrs modules / 10 yrs inverter" },
      { label: "Delivery", value: "30–120 days" },
    ...
    caseStudy: {
      ...
      capacity: "1.2 MW dc",
      result:
        "42% grid offset achieved in year one — 3.6 year payback with accelerated depreciation.",
    },
    faqs: [
      {
    ...
    gallery: [imgEpc, hero1, projUtility, hero3, projIndustrial, solarHouse],
  },
  {
    slug: "rooftop-solar",
    icon: Home,
    ...
    process: [
      { title: "Free Site Visit", desc: "Roof survey and shadow mapping within 48 hrs." },
      { title: "Custom Proposal", desc: "Detailed savings and ROI report." },
      { title: "Approvals", desc: "We file DISCOM and subsidy paperwork." },
      { title: "Installation", desc: "2–5 day install with zero disruption." },
      { title: "Handover", desc: "Net-meter installed, app configured, 25-yr support." },
    ],
    specs: [
      { label: "Capacity", value: "1 kW – 25 kW" },
      { label: "Subsidy", value: "Up to ₹78,000" },
      { label: "Install time", value: "2–5 days" },
      { label: "Bill savings", value: "Up to 90%" },
    ],
    techStack: [
    ...
    gallery: [imgRooftop, solarHouse, projResidential, hero2, hero1, projCommercial],
  },
  {
    slug: "ground-mounted",
    icon: Factory,
    ...
    process: [
      { title: "Land Study", desc: "Topography, soil and irradiance analysis." },
      { title: "PPA / OA Strategy", desc: "Open-access, group captive or PPA modelling." },
      { title: "Detailed Engineering", desc: "PVsyst yield, GCR and BoS optimisation." },
      { title: "Construction", desc: "Foundation, module mounting, cabling, HT works." },
      { title: "Grid Sync", desc: "STU/CTU approval and commissioning." },
    ],
    specs: [
      { label: "Capacity", value: "500 kW – 10 MW+" },
      { label: "Type", value: "Fixed-tilt / Tracker" },
      { label: "Delivery", value: "4–9 months" },
      { label: "PR", value: "80%+ guaranteed" },
    ],
    techStack: [
    ...
    caseStudy: {
      ...
      capacity: "5 MW ac",
      result:
        "PR of 82.4% in year one — 6% above lender base case; open-access tariff locked for 25 years.",
    },
    faqs: [
      {
    ...
    gallery: [imgGround, projUtility, hero3, hero1, projIndustrial, imgEpc],
  },
  {
    ...
    benefits: [
      ...
      { title: "Tax benefits", desc: "80% accelerated depreciation in year one under Section 32." },
      {
    ...
    process: [
      { title: "Energy Audit", desc: "Load profile, tariff and demand analysis." },
      { title: "Commercial Model", desc: "CAPEX vs OPEX vs RESCO evaluation." },
      { title: "Engineering", desc: "HT single-line, protection and metering design." },
      { title: "Execution", desc: "Zero-disruption install with weekend cutovers." },
      { title: "O&M", desc: "24×7 SCADA monitoring and preventive AMC." },
    ],
    specs: [
      { label: "Capacity", value: "100 kW – 5 MW" },
      { label: "Models", value: "CAPEX / OPEX / RESCO" },
      { label: "Bill offset", value: "Up to 70%" },
      { label: "Payback", value: "3–4 years" },
    ],
    techStack: [
    ...
    caseStudy: {
      ...
      capacity: "800 kW dc",
      result:
        "68% daytime load offset, ₹1.4 crore annual savings, 3.1-year payback with AD benefit.",
    },
    faqs: [
      {
    ...
    gallery: [imgIndustrial, projIndustrial, projCommercial, hero2, imgEpc, hero3],
  },
  {
    ...
    benefits: [
      { title: "Zero diesel", desc: "Eliminate ₹30,000+ annual diesel spend per pump." },
      { title: "60% subsidy", desc: "Up to 60% central+state subsidy under PM-KUSUM Component B." },
      {
    ...
    process: [
      { title: "Beneficiary Enrolment", desc: "PM-KUSUM registration support." },
      { title: "Site Survey", desc: "Bore depth, water yield and land audit." },
      { title: "Subsidy Processing", desc: "State + centre subsidy documentation." },
      { title: "Installation", desc: "Complete civil, structural and electrical works." },
      { title: "Handover", desc: "Training, warranty and remote monitoring." },
    ],
    specs: [
      { label: "Capacity", value: "1 HP – 15 HP" },
      { label: "Subsidy", value: "Up to 60% (PM-KUSUM)" },
      { label: "Warranty", value: "5 years" },
      { label: "Payback", value: "2–3 years" },
    ],
    techStack: [
      "Mono-PERC modules",
    ...
    gallery: [imgPump, hero2, hero1, imgGround, projResidential, hero3],
  },
  {
    ...
    benefits: [
      { title: "Zero electricity bill", desc: "Fully off-grid — no meter, no monthly cost." },
      {
        title: "Smart dimming",
    ...
    process: [
      { title: "Site Design", desc: "Pole spacing and lumen mapping." },
      { title: "Approvals", desc: "PWD / municipal clearance support." },
      { title: "Supply", desc: "Poles, luminaires and hardware kits." },
      { title: "Installation", desc: "Foundation, erection and commissioning." },
      { title: "AMC", desc: "Annual maintenance and battery health checks." },
    ],
    specs: [
      { label: "Wattage", value: "12 W – 60 W LED" },
      { label: "Autonomy", value: "3 nights" },
      { label: "Battery", value: "LiFePO₄, 5-yr life" },
    ...
    gallery: [imgStreet, hero1, hero3, projCommercial, imgEpc, hero2],
  },
  {
    ...
    process: [
      { title: "Load Study", desc: "Backup and peak-shaving analysis." },
      { title: "System Sizing", desc: "kWh, C-rate and inverter matching." },
      { title: "Engineering", desc: "Enclosure, HVAC and safety design." },
      { title: "Installation", desc: "Turnkey civil, mechanical and electrical." },
      { title: "Monitoring", desc: "24×7 remote BMS and analytics." },
    ],
    specs: [
      { label: "Capacity", value: "5 kWh – 5 MWh" },
    ...
    caseStudy: {
      ...
      result:
        "MD reduced 35%, diesel gensets decommissioned — 4.5-year payback on demand-charge savings alone.",
    },
    faqs: [
      {
    ...
    gallery: [imgBattery, imgIndustrial, hero3, projIndustrial, hero1, imgEpc],
  },
  {
    slug: "om-amc",
    icon: Wrench,
    ...
    process: [
      { title: "Audit", desc: "Baseline plant health and yield audit." },
      { title: "AMC Plan", desc: "Custom SLA with response commitments." },
      { title: "Monitoring Setup", desc: "SCADA integration and dashboards." },
      { title: "Preventive M&", desc: "Scheduled cleaning, inspection and testing." },
      { title: "Reporting", desc: "Monthly PR and yield reports." },
    ],
    specs: [
      { label: "Response SLA", value: "< 24 hours" },
      { label: "Uptime", value: "99%+ guaranteed" },
      { label: "Cleaning", value: "Monthly / bi-monthly" },
    ...
    caseStudy: {
      ...
      result:
        "Portfolio PR restored from 74% to 82% within 6 months — additional 1.1M kWh generated annually.",
    },
    faqs: [
      {
    ...
    gallery: [imgOm, imgIndustrial, projUtility, hero2, imgEpc, hero1],
  },
];
