  ...
  component: () => (
    <AdminCrud
      ...
      fields={[
        ...
        { key: "slug", label: "Slug", type: "text", required: true, placeholder: "solar-rooftop" },
        { key: "icon_name", label: "Icon (lucide)", type: "text" },
        { key: "short_description", label: "Short description", type: "textarea", colSpan: 2 },
        { key: "long_description", label: "Long description", type: "textarea", colSpan: 2 },
        ...
        { key: "benefits", label: "Benefits", type: "array", colSpan: 2 },
